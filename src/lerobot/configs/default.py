...
class PeftConfig:
    ...
    # Dropout applied to the adapter input. If None, the PEFT library default (0.0) applies,
    # which preserves the previous behaviour of this config. Raise it to regularize
    # high-rank adapters on small finetuning sets.
